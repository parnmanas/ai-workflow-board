...
export function useBoard(boardId: string = '') {
  ...
  const updateColumn = async (columnId: string, data: { name?: string; color?: string; position?: number; description?: string; is_terminal?: boolean; unassigned_policy?: 'halt' | 'skip' | 'skip_if_ticket_staffed'; process_subtasks?: boolean }) => {
