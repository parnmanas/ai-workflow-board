 ...
 *  subagent surface anything?" contract. BaseSessionManager invokes the exit
 *  hook on ChildProcess `close`, after stdout/stderr drain, so this
 *  cycle-local scanner is also the correctness boundary (ticket 07fc0c00). */
